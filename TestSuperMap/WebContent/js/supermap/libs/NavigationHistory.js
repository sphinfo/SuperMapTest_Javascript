 ...
 *  - <OpenLayers.Control>
 */
SuperMap.Control.NavigationHistory = SuperMap.Class(SuperMap.Control, {
     ...
     */
    type: SuperMap.Control.TYPE_TOGGLE,
    ...
    initialize: function(options) {
        ...
        this.registry = SuperMap.Util.extend({
            "moveend": this.getState
        }, this.registry);
        
        var previousOptions = {
            trigger: SuperMap.Function.bind(this.previousTrigger, this),
            displayClass: this.displayClass + " " + this.displayClass + "Previous"
        };
        SuperMap.Util.extend(previousOptions, this.previousOptions);
        this.previous = new SuperMap.Control.Button(previousOptions);
        
        var nextOptions = {
            trigger: SuperMap.Function.bind(this.nextTrigger, this),
            displayClass: this.displayClass + " " + this.displayClass + "Next"
        };
        SuperMap.Util.extend(nextOptions, this.nextOptions);
        this.next = new SuperMap.Control.Button(nextOptions);
    ...
    restore: function(state) {
        ...
        if (this.map.getProjectionObject() == state.projection) { 
            ...
            var resolutionFactor = sourceUnits && targetUnits ? 
                SuperMap.INCHES_PER_UNIT[sourceUnits] / SuperMap.INCHES_PER_UNIT[targetUnits] : 1;
    ...
    setListeners: function() {
        ...
        for(var type in this.registry) {
            this.listeners[type] = SuperMap.Function.bind(function() {
                if(!this.restoring) {
    ...
    activate: function() {
        var activated = false;
        if(this.map) {
            if(SuperMap.Control.prototype.activate.apply(this)) {
    ...
    deactivate: function() {
        ...
        if(this.map) {
            if(SuperMap.Control.prototype.deactivate.apply(this)) {
                for(var type in this.listeners) {
    ...
    CLASS_NAME: "SuperMap.Control.NavigationHistory"
});
